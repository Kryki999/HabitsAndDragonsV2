...
Cienki scaffold: `apps/mobile` (Expo Router, 5 tabów z `18`). **Questy** = lokalne nawyki z feel Zamku (lista, overlay, kalendarz, heatmapa — bez ekonomii RPG); mapa / Hero / social / Mentor = later. V1 nie jest kotwicą architektury — [`reference/v1-to-v2-architecture-audit.md`](reference/v1-to-v2-architecture-audit.md), UX Zamku: [`reference/v1-quests-ux-audit.md`](reference/v1-quests-ux-audit.md).
